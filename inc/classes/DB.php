...
class DB {
	...
	private function __construct() {
		...
		try {
			...
			self::$con = new PDO( 'mysql:charset=utf8mb4;host=masterbuilder-db-instance.cqsvf5cnuvts.us-east-1.rds.amazonaws.com;port=3306;dbname=sample', 'mb_user1', 'mb_user1' );
